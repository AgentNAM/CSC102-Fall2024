...
function validateForm(){
    ...
    if (fullName.length > 20 || fullName.length == 1){
        ...
        document.getElementById("loginStatus").innerHTML = "Welcome, " + fullName + ". The secret word is hippopotomonstrosesquippedaliophobia.";
        //alert("Welcome, " + fullName + ". The secret word is hippopotomonstrosesquippedaliophobia.");
    }
...
function playSound(){
    ...
    audio.play();
    // log that the playing started to the console in case of sound issues
...
function pauseSound(){
    ...
    audio.pause();
    // log that the playing paused to the console in case of sound issues
